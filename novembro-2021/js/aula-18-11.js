...
document.getElementById('h1-in-my-hobbies').innerHTML = "Escalada";
document.getElementById('p1-in-my-hobbies').innerHTML = "O meu maior hobby seguramente é o esporte " +
    "conhecido como escalada, de todos os tipos, mas principalmente na rocha.";
const link = document.getElementById('link-in-my-hobbies')
link.innerHTML = "Mais informações...";
